                        ...
                        <div class="documents" style="width: 50%; padding-left: 20px;">
                            ...
                            <?php if ($evaluation['eligibility_form']): ?>
                                <ul class="documents-list" style="list-style: none; padding: 0;">
                                    ...
                                    <li style="margin-bottom: 5px;">
                                        <i class="fas fa-file-alt" style="margin-right: 5px;"></i>
                                        <a href="/sms/assets/uploads/evaluations/<?= $evaluation['athlete_id'] ?>/<?= $evaluation['tryout_form'] ?>"
                                            target="_blank" style="color: #007bff;"
                                            download="<?= $evaluation['full_name'] . ' Try-out Form' ?>">Try-out Form</a>
                                    </li>
                                    <li style="margin-bottom: 5px;">
                                        <i class="fas fa-file-medical" style="margin-right: 5px;"></i>
                                        <a href="/sms/assets/uploads/evaluations/<?= $evaluation['athlete_id'] ?>/<?= $evaluation['med_cert'] ?>"
                                            target="_blank" style="color: #007bff;"
                                    ...
                                    <li style="margin-bottom: 5px;">
                                        <i class="fas fa-file-alt" style="margin-right: 5px;"></i>
                                        <a href="/sms/assets/uploads/evaluations/<?= $evaluation['athlete_id'] ?>/<?= $evaluation['cor'] ?>"
                                            target="_blank" style="color: #007bff;"
                                    ...
                                    <li>
                                        <i class="fas fa-file-alt" style="margin-right: 5px;"></i>
                                        <a href="/sms/assets/uploads/evaluations/<?= $evaluation['athlete_id'] ?>/<?= $evaluation['grades'] ?>"
                                            target="_blank" style="color: #007bff;"
