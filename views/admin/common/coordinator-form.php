...
<input type="text" class="sms-input text-only" id="first_name" name="first_name" value="<?= $request['first_name'] ?? '' ?>" required>

<label for="middle_name" class="label">Middle Name:</label>
<input type="text" class="sms-input text-only" id="middle_name" name="middle_name" value="<?= $request['middle_name'] ?? '' ?>">

<label for="last_name" class="label">Last Name:</label>
<input type="text" class="sms-input text-only" id="last_name" name="last_name" value="<?= $request['last_name'] ?? '' ?>" required>

<label for="address" class="label">Address:</label>
<input type="text" class="sms-input no-special-chars" id="address" name="address" value="<?= $request['address'] ?? '' ?>" required>
...
<input type="text" class="sms-input num-only" id="phone_number" name="phone_number" maxlength="11" value="<?= $request['phone_number'] ?? '' ?>">
