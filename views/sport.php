  ...
  <div class="container">
    <div class="content">
      <div class="title-container">
        <p><img src="basketball_icon.png" alt="Basketball Icon"><a href="#" onclick="showInfo('Basketball')">Basketball</a></p>
        ...
        <p><img src="swimming_icon.png" alt="Swimming Icon"><a href="#" onclick="showInfo('Swimming')">Swimming</a></p>
      </div>
    </div>
  </div>
