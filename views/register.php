...
<head>
    ...
    <link rel="stylesheet" href="assets/css/register.css"> <!-- Link to the external CSS file -->
</head>
        ...
        <div class="form-container">
            <form action="register/create" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-field">
                    ...
                    <input type="text" id="course" name="course" placeholder="Year & Course" required>
                </div>
                <div class="form-field">
                ...
                <div class="form-field">
                    <label for="email">Email (G Suite Account)</label>
                ...
                <div class="form-field">
                    ...
                    <input type="text" id="guardian" name="guardian" placeholder="Guardian" required>
                </div>
                <div class="form-field">
                ...
                <div class="form-field">
                    ...
                    <div class="dropdown">
                        <input type="text" id="sport" name="sport" placeholder="Type to search sports">
                        <div id="sports-dropdown" class="dropdown-content"></div>
                    </div>
                </div>
                <div class="form-field">
                    <label for="phone_number">Phone Number</label>
                    <input type="tel" id="phone_number" name="phone_number" placeholder="Phone Number (11 digits)" pattern="\d{11}" required>
                </div>
                <div class="form-field">
                ...
                <div class="form-field">
                    <label for="picture">2x2 Picture with White Background</label>
